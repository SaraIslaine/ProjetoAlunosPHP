                   ...
                   <tr>
                      ...
                      <form action="conexao.php" method="post">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="situacao" id="ativar<?=$aluno["id"]?>" value="1" <?php if ($aluno["situacao"] == 1) { echo 'checked'; } ?> >
                               
                            <button type="submit" class="btn btn-secondary"><?php if ($aluno["situacao"] == 1) { echo 'Inativo'; }else{ echo 'Ativo';} ?> </button>
                            </div>
                        </form>
                      </th>
                  </tr>   
